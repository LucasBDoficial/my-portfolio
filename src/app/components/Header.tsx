    ...
    return(
        ...
        transition={{
          ...
          delay: 0.5,
            ...
            <div className="flex absolute right-72 space-x-10 items-center
                max-sm:static">
                ...
                <Link href="https://accounts.google.com/SignOutOptions?hl=en&continue=https://mail.google.com&service=mail&ec=GBRAFw">
                    <svg className="hover:ld"
                ...
                <Link href="https://www.linkedin.com/in/jo%C3%A3o-lucas-bucalon/">
                    <svg className="hover:ld"
                    xmlns="http://www.w3.org/2000/svg" width="2.3rem" height="2.3rem" viewBox="0 0 24 24"><path fill="currentColor" d="M12.001 9.55c.917-.937 2.111-1.55 3.5-1.55a5.5 5.5 0 0 1 5.5 5.5V21h-2v-7.5a3.5 3.5 0 1 0-7 0V21h-2V8.5h2v1.05Zm-7-3.05a1.5 1.5 0 1 1 0-3a1.5 1.5 0 0 1 0 3Zm-1 2h2V21h-2V8.5Z"/></svg></Link>   

                <Link href="https://wa.me/5519997817785">
                    <svg className="hover:ld"
                ...
                <Link href="https://lucasbdoficial.github.io/mylinks/">
                    <svg className="hover:ld"
