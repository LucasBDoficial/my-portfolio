        ...
        <motion.nav className="fixed right-0 flex h-full items-center mr-[15px] z-[90]
            ...
            <ul className="old py-11 px-2 rounded-full flex flex-col space-y-8 min-mt-90
                ...
                <a href="./About" className="group items-center flex" >           
                    <p className="absolute right-[54px] bgb py-1 px-2 rounded-md text-lg italic hidden sm:group-hover:flex z-10 group:">Sobre</p>
                    <i className="w-5 h-5 bgb rotate-45 rounded-md absolute right-[50px] hidden sm:group-hover:flex" /> 
                        <svg className="hover:ld"
                ...
                <a href="./Work" className="group items-center flex" >           
                    <p className="absolute right-[54px] bgb py-1 px-2 rounded-md text-lg italic hidden sm:group-hover:flex z-10 group:">Trabalho</p>
                    <i className="w-5 h-5 bgb rotate-45 rounded-md absolute right-[50px] hidden sm:group-hover:flex" /> 
                        <svg className="hover:ld"
                ...
                <a href="./Gallery" className="group items-center flex" >           
                    <p className="absolute right-[54px] bgb py-1 px-2 rounded-md text-lg italic hidden sm:group-hover:flex z-10 group:">Galeria</p>
                    <i className="w-5 h-5 bgb rotate-45 rounded-md absolute right-[50px] hidden sm:group-hover:flex" /> 
                        <svg className="hover:ld"
                ...
                <a href="./Feedback" className="group items-center flex" >           
                    <p className="absolute right-[54px] bgb py-1 px-2 rounded-md text-lg italic hidden sm:group-hover:flex z-10 group:">Depoimento</p>
                    <i className="w-5 h-5 bgb rotate-45 rounded-md absolute right-[50px] hidden sm:group-hover:flex" /> 
                        <svg className="hover:ld"
