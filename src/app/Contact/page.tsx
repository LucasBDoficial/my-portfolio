        ...
        <div className="w-full h-full flex justify-center items-center">
            ...
            <div className="w-[50%] old absolute rounded-[20px] py-[5%] flex flex-wrap justify-center max-[900px]:w-[80%]">
                ...
                <div className="w-full h-full flex space-x-10 mt-[30px] px-[3%] max-[900px]:flex-wrap max-[900px]:space-x-0 max-[900px]:space-y-10">
                    ...
                    <Link href="https://wa.me/5519997817785" className="w-[50%] hover:ld bor flex flex-wrap justify-center p-[3%] max-[900px]:w-full" >
                    ...
                    <Link href="mailto:lucasbdoficial@gmail.com" className="w-[50%] hover:ld bor flex flex-wrap justify-center p-[3%] max-[900px]:w-full" >
