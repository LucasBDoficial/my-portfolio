    ...
    >
      ...
      <div className="w-full h-full flex justify-center items-center">
        <div className="w-[50%] old absolute rounded-[20px] py-[5%] flex flex-wrap justify-center max-[900px]:w-[80%]">
          <h2 className="w-full text-center mt-[-5%] font-meduim text-[2.4rem]">
          ...
          <div className="w-full h-full flex space-x-10 mt-[30px] px-[3%] max-[900px]:flex-wrap max-[900px]:space-x-0 max-[900px]:space-y-10">
            <Link
              ...
              className="w-[50%] hover:ld bor flex flex-wrap justify-center p-[3%] max-[900px]:w-full"
            >
              <svg
              ...
              <p className="w-full mt-[30px] text-center font-medium text-[1.8rem]">
                (+55) 19 99781-7785
              </p>
            </Link>
