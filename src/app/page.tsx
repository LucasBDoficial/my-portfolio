    ...
    >
      ...
      <div className="w-[50%] relative flex flex-col justify-center  mt-[30px] max-[900px]:w-full">
        ...
        <Image
          ...
          width={350}
          height={350}
          className="relative mx-auto pr-[9px] z-20 mt-[30px]"
          id="image1"
        />
      ...
      <div
        className="w-[50%] flex justify-center items-center mr-[5%] mt-[40px] z-20 pb-[20px]
          max-[900px]:w-full max-[900px]:items-start max-[900px]:mr-[0] "
      >
        <div className="absolute text-center">
          <h2 className="font-black text-[3.5rem] leading-[40px]">
          ...
          <p className="italic text-[1.2rem] text-right mt-[10px]">
